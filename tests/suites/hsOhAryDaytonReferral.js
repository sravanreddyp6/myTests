...
testSuite("hsOhAryDaytonReferral", suiteTimeout, {
  "should create a Hastings OH Referral successfully": function(client, done) {
   var user = users["HS_AL_Auburn_Referral_Intaker"];
    return client
      .logInAs(users["HS_OH_AryDayton_Referral_Intaker"])
      ...
      .then(function(refSrcType) {
          assert.deepEqual(["", "Attorney", "Counselor", "Family", "Hospital Case Manager", 
                            "Independent Case Manager", "Internal", "Juvenile Justice", "Other therapist", 
