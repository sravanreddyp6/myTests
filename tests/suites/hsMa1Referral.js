...
//		})
        ...
        .chooseSelectOption("If the referral is from the ICC has the care plan been submitted to the insurance company in order for us to obtain an authorization for services?", "No")		
		.fillInputText("Describe Any Household Pets","Describe Any Household Pets Test")
		.fillInputText("Goals from the Referral Source","Goals from the Referral Source Test")
		...
		.then(function(ServicesRequested) {
			assert.deepEqual(["2"], ServicesRequested);
		})		
