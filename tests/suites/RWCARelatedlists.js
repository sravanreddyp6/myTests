...
testSuite("RWCARelatedLists", suiteTimeout, {
  ...
  var today = new Date().getMilliseconds() + new Date().getDate();
    return client
      ...
      .chooseSelectOption("Service Being Funded", "Day Programs")
