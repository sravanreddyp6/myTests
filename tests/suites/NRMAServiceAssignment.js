...
testSuite("NRMAServiceAssignment", suiteTimeout, {
  "Should Create/Edit/View/Close/promptFullDischarge a NeuroRestorative MA Service Assignment successfully": function(client, done) {
    return client
      //Referral Conversion
      ...
      .setValue("input[id$=nameFilter]","130201")
