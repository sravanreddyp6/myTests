...
*/    })
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=ServAssign 1",defaultOperationTimeout,true)
		 //A2
		.scroll("a=Penguins.txt")
		.click("a=Penguins.txt")
		.click("input[value='Edit']")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=ServAssign 4",defaultOperationTimeout,true)
		//A9/11/12
    .scroll("input[value='View All']")
    .click("input[value='View All']")
		.click("a=Tulips.txt")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=ServAssign 5",defaultOperationTimeout,true)
		//R1/7
		.scroll("a=Koala.txt")
		.click("a=Koala.txt")
		//R2
...
*/    })
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Action 1",defaultOperationTimeout,true)
		 //A2
		.scroll("a=Penguins.txt")
		.click("a=Penguins.txt")
		.click("input[value='Edit']")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Action 4",defaultOperationTimeout,true)
		//A9/11/12
    .scroll("input[value='View All']")
    .click("input[value='View All']")
		.click("a=Tulips.txt")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Action 5",defaultOperationTimeout,true)
		//R1/7
		.scroll("a=Koala.txt")
		.click("a=Koala.txt")
		//R2
...
*/    })
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Summary 1",defaultOperationTimeout,true)
		 //A2
		.scroll("a=Penguins.txt")
		.click("a=Penguins.txt")
		.click("input[value='Edit']")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Summary 4",defaultOperationTimeout,true)
		//A9/11/12
    .scroll("input[value='View All']")
    .click("input[value='View All']")
		.click("a=Tulips.txt")
    ...
    .click("input[value='Cancel']")
    .waitForExist("td=Summary 5",defaultOperationTimeout,true)
		//R1/7
		.scroll("a=Koala.txt")
		.click("a=Koala.txt")
		//R2
