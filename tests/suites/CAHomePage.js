...
testSuite("CAHomePage", suiteTimeout, {
"CAHomePage": function(client, done) {
	var APPuser = users["RW_CA_DSP1APP"];
	var Lvl1user = users["RW_CA_DSP"];
	var Lvl3user = users["RW_CA_L3"];
	...
	return client
		...
		hooks: {
      	"create_referral_initial_referral": function (client) {
			...
			.click("table[id$=table2] tbody tr:nth-child(5) td:nth-child(1) a")
        }
        }
		})
