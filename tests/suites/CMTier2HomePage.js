...
testSuite("CMTier2HomePage", suiteTimeout, {
"CMTier2HomePage": function(client, done) {
	var user1 = users["CM_DON"];
	var user2 = users["CM_Nurse"];
	var user3 = users["CM_LVN"];
	var user4 = users["CM_CaseManager"];
	...
	return client
		...
		.selectByVisibleText("select[class=actionList]","Create New Shift Doc")
		...
		.setValue("input[id=shiftStartDate1]",date+" "+"01:01\t")
		.setValue("input[id=shiftEndDate1]",date+" "+time+"\t")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate2]",date+" "+"01:02\t")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate1]",date+" "+"01:03\t")
		.setValue("input[id=shiftEndDate1]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate2]",date+" "+"01:04\t")
		.setValue("input[id=shiftEndDate2]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate1]",date+" "+"01:05\t")
		.setValue("input[id=shiftEndDate1]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate2]",date+" "+"01:06\t")
		.setValue("input[id=shiftEndDate2]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate1]",date+" "+"01:07\t")
		.setValue("input[id=shiftEndDate1]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Save']", defaultOperationTimeout)
		.setValue("input[id=shiftStartDate2]",date+" "+"01:08\t")
		.setValue("input[id=shiftEndDate2]",date+" "+time+"\t")
		.click("div[aria-labelledby$='shiftDocModal'] input[value='Save']")
		.waitForVisible("div[aria-labelledby$='shiftDocModal'] input[value='Cancel']",defaultOperationTimeout,true)
		.url("https://c.cs4.visual.force.com/apex/Home")
