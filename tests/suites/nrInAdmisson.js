...
testSuite("hsGaAdmission", suiteTimeout, {
  ...
  return client
	.execUtil("convert_referral", { operatingGroup: "NeuroRestorative", flavor: "IN" })
	...
	.waitForVisible("div[Id$=dischargeinfo2]", defaultOperationTimeout)
