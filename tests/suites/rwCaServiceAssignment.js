...
testSuite("rwCaServiceAssignment", suiteTimeout, {
  "Should Create/Edit/View/Close/promptFullDischarge a Redwood CA Service Assignment successfully": function(client, done) {
    return client
      //Referral Convertion
      ...
      .setValue("input[id$=nameFilter]","109100")
      ...
      .then(function(endSC) {
        assert.deepEqual([
          "", "Aged out of care", "Behavioral needs exceed ability to serve", "Court decision-custody returned to bio family", 
      ...
      .then(function (eoSerC) {
        assert.equal("Aged out of care", eoSerC.trim());
      })      
