 ...
 *
 *LastModifiedBy: Adam Vernatter 06/15/2016
 *LastModifiedReason: Updates for PBS page split
 * 
 * 
 * 
 * 
...
testSuite("pbseditnewNR", suiteTimeout, {
	...
	.execUtil("convert_referral",{
		...
		hooks:{
          ...
          .click("a=iServe Home")
		  .addValue("[id$=PbsSearchProgram]",'101010')
	      .click("input[type='submit'][value='Find']", defaultOperationTimeout)
	      .waitForActionStatusDisappearance("pageProcessing", defaultOperationTimeout)
	      .waitForVisible("span[id$=searchResultDialog]", defaultOperationTimeout)
...
//	      .fillInputText("Family Native American Tribe", "Test")
	      ...
	      .then(function () { console.log('Validate fields on PBS view page'); })
	     ...
	     /* .getOutputText("Primary Language")
	      ...
	      .then(function () { console.log('Confirm sections and buttons that should be present are on the page'); })
	      ...
	      .then(function () { console.log('Confirm sections and buttons that should not be present are NOT on the page'); })
	      ...
	      //These Fields should NOT be present on the Page
	      .then(function () { console.log('Confirm fields that should not be present are NOT on the page'); })
