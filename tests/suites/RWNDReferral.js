...
testSuite("RWNDReferral", suiteTimeout, {
  "should create a Redwood ND Referral successfully": function(client, done) {
...
//		})
        ...
        .selectByValue('select[id$=MN_State]', "North Dakota")
        ...
        .setValue("input[id$=addlocationstate]", "ND")
        ...
        .then(function(funSource) {
         assert.deepEqual(["", "Commercial Insurance", "HCBS Waiver", "Money Follows the Person", "NDDHS", 
                                "Private Pay", "Workers Compensation"], funSource);
         })
	    .chooseSelectOption("Funding Source", "Private Pay")
