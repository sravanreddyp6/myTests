  ...
  "should create a Redwood MN Referral successfully": function(client, done) {
    ...
    return client
        ...
        .then(function(refSrcType) {
            assert.deepEqual(["", "Independent Case Manager", "Rehab/Hospital", "Self", "Social Worker"], refSrcType);
		})
...
//		.fillInputText("Date of Injury","1/1/2000")
        ...
        .selectByValue('select[id$=MN_State]', "Minnesota")
