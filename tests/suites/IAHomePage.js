...
"IAHomePage": function(client, done) {
	...
	var Lvl3IAManag = users["RW_IA_Management"];
	...
	return client
		...
		.click("input#Login")
		.pause(2000)
		.url("https://c.cs4.visual.force.com/apex/DSPHome")
		.then(function () {
		...
		.click("a=Acknowledge")
		.url("https://c.cs4.visual.force.com/apex/DSPHome")
		.selectByVisibleText("select[id$=actionlist]","Acknowledge Risk Assessment")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value=Acknowledge]", defaultOperationTimeout)
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value='Add Time Log']", defaultOperationTimeout)
		.url("https://c.cs4.visual.force.com/apex/DSPHome")
		...
		.waitForVisible("div[class=thinking]",defaultOperationTimeout, true)	
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[class$=actionList]","Record Seizure")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value='Add Seizure']", defaultOperationTimeout)
		.click("input[value='Add Seizure']")
		.switchToNextWindow()
		...
		.switchToNextWindow()
		.click("div[id='p'] input[value='Acknowledge']")
		.waitForVisible("input[value=Acknowledge]",defaultOperationTimeout, true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[class$=actionList]","Create Daily Data Summary")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.switchToNextWindow()
		.waitForVisible("a=Generate", defaultOperationTimeout)
		...
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[id$=navigationList]","Plan of Care")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(6) input")
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[id$=navigationList]","Risk Assessment")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(6) input")
		...
		.waitForVisible("input[value=Run]", defaultOperationTimeout)	
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[id$=navigationList]","Time Log Entry")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(6) input")
		.waitForVisible("input[value='Add Time Log']", defaultOperationTimeout)
		//Level 3
		.logInAs(Lvl3user)
		...
		.waitForVisible("input[value=Acknowledge]",defaultOperationTimeout, true)
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[class$=actionList]","Create Time Log Entry")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value='Save']", defaultOperationTimeout)
		.click("a[id*=lkwgt]")
		.switchToNextWindow()
		...
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.switchToNextWindow()
		.waitForVisible("input[id='IowaDailyDataSummaryServiceDate']", defaultOperationTimeout)
		.setValue("input[id='IowaDailyDataSummaryServiceDate']",date)
		.click("a=Generate")
		.click("a=Close")
		.selectByVisibleText("select[id$=navigationList]","Action Plan")
