...
"MNHomePage": function(client, done) {
	var APPuser = users["RW_MN_DSP"];
	var Lvl3user = users["RW_MN_L3"];
	var Management = users["RW_MN_Management"];
	...
	return client
		...
		.waitForVisible("input[value='Attach File']", defaultOperationTimeout)
		.scroll("input[value='Add/Edit Documents']")
		.click("input[value='New ISSA Assessment']")	  
		.waitForVisible("input[value='Finalize']", defaultOperationTimeout)
		.click("input[value='Finalize']")	  
		.waitForVisible("input[value='Save']", defaultOperationTimeout)
		.fillInputText("Approval Date","1/12/2016")
		...
		.waitForVisible("table[class=list] tbody tr:nth-child(1) td:nth-child(1)", defaultOperationTimeout)
		.url("https://c.cs4.visual.force.com/apex/DSPHome")
		...
		.url("https://c.cs4.visual.force.com/apex/DSPHome")
		.selectByVisibleText("select[id$=actionlist]","Acknowledge ISSA Assessment")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value=Acknowledge]", defaultOperationTimeout)
		...
		.waitForVisible("span[id$=skillsWS]", defaultOperationTimeout)
		.url("https://c.cs4.visual.force.com/apex/Home")
		.selectByVisibleText("select[class=actionList]","Acknowledge ISSA Assessment")
		.click("table[id$=serviceAssignmentTable] tbody tr:nth-child(1) td:nth-child(5) input")
		.waitForVisible("input[value=Acknowledge]", defaultOperationTimeout)
		.click("input[value=Acknowledge]")
		.switchToNextWindow()
