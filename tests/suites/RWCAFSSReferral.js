  ...
  "should create a Redwood CAFSS Referral successfully": function(client, done) {
    ...
    return client
        ...
        .then(function(refSrcType) {
			...
			"Physician", "Rehab/Hospital", "School", "Self", "Social Worker", "Other"], refSrcType);
		})
		...
		.fillInputText("Payer/Guarantor Medical Record Number", "61555890")
		.fillInputText("Payer/Guarantor Medical Record Number Description", "Test")
...
//		})
		...
		.then(function(closeReason) {
			assert.deepEqual([
			  ...
			  "Error", "Funding Inadequate", "Inquiry Only", "Mentor Refused Placement", "No Match 2nd Client Issues", 
			  "No match geography", "No Match required no children in the home", "No Open Bed", "No Response",
