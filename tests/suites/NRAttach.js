...
testSuite("NRAttach", suiteTimeout, {
  "should add a diagnosis successfully": function(client, done) {
  var user = users["NR_referralsonly"];
    var saveurl;
    return client
      ...
      .isExisting("span=Choose file")
		...
		.waitForVisible("input[id='uploader:j_id26:component:attForm:j_id1126:j_id1129:0:files:j_id1143:j_id1145:0']", defaultOperationTimeout)
      ...
      .waitForVisible("input[value='Upload']", defaultOperationTimeout)
		...
		.click("input[id='uploader:j_id26:component:attForm:j_id1126:j_id1129:0:files:j_id1143:j_id1145:0']")
		.click("input[value='Upload']")
		//U7
		.waitForVisible("a*=PlanOfCare", defaultOperationTimeout)
		.click("input[value='Add Multiple']")
      .waitForVisible("input[value='Upload']", defaultOperationTimeout)
		.chooseFile("input[id='uploader:j_id26:component:attForm:j_id1126:j_id1129:0:files:j_id1130:test']","Penguins.txt")
		.chooseFile("input[id='uploader:j_id26:component:attForm:j_id1126:j_id1129:1:files:j_id1130:test']","Tulips.txt")
...
*/
		...
		.click("a*=Admission 1 - NeuroRestorative")
		//U1
      .waitForVisible("input[value='Attach File']", defaultOperationTimeout)
		.scroll("input[value='Attach File']")
		.click("input[value='Attach File']")
      ...
      .click("input[value='Cancel']")
		...
		//R5/6???
		//Service Assignment
		.scroll("a=N. MA - SA1 - 130201 - ABI - Asmt Only")
		.click("a=N. MA - SA1 - 130201 - ABI - Asmt Only")
		//U1
      .waitForVisible("input[value='Attach File']", defaultOperationTimeout)
		.scroll("input[value='Attach File']")
		.click("input[value='Attach File']")
	...
	/*	.getUrl().then(function(url) {
      ...
      .waitForVisible("input[value='Save']", defaultOperationTimeout)
		...
		.click("input[value='Save']")
		.logInAs(users["NR_referralsonly"])
		.then(function () {
			return client.url(saveurl)
		})		
		//Action Plan
		.click("img[class='unstickPbs']")
		.scroll("span*=NeuroRestorative ")
		.click("span*=NeuroRestorative ")
		//U1
      .waitForVisible("input[value='Attach File']", defaultOperationTimeout)
		.click("input[value='Attach File']")
		//U3
