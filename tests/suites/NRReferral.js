...
//		})
		...
		.waitForVisible("img[class='waitingImage']", defaultOperationTimeout,true)
		...
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(2) td:nth-child(4) input","Verbally Aggressive Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(2) td:nth-child(6) input","Theft Test")
		.getSelectOptionsBySelector("span[id=progConsid] table[class=detailList] tbody tr:nth-child(2) td:nth-child(8) select")
		.then(function(unwantedBehav) {
			assert.deepEqual(["", "Issue", "Aggression", "Acting Out"], unwantedBehav);
		})
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(4) td:nth-child(4) input","Suicide Threats Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(4) td:nth-child(6) input","Tobacco Use (Current) Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(4) td:nth-child(8) input","Current Pending Litigation Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(6) td:nth-child(2) input","Physically Aggressive To Self Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(6) td:nth-child(4) input","Suicide Attempts Test")
		.fillInputText("Date Completed","1/1/2000")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(8) td:nth-child(4) input","Physically Aggressive To Peers Test")
		.setValue("span[id=progConsid] table[class=detailList] tbody tr:nth-child(8) td:nth-child(6) input","Self-Harm or Self-Injurious Behaviors Test")
