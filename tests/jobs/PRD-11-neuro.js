...
execJobs({"PRD-11": function(client, done) {
        var sa = JSON.parse(stripJsonComments(fs.readFileSync("./jobs/json/all-neuro-sas.json", "utf8")));
        var pbs_admissions = JSON.parse(stripJsonComments(fs.readFileSync("./jobs/json/all-neuro-pbs-admissions.json", "utf8")));
   ...
   client =  client
	...
	.url("https://cs4.salesforce.com/005U0000003ASKBIA4?noredirect=1&isUserEntityOverride=1")
	.pause(5000)
	.click("input[value=' Login ']")
	.pause(5000)

	.then(function() {console.log("..Performed a Login *As* Jennifer Surprenant."); })
