...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Employee_EndDate_Has_Changed</fullName>
        <actions>
            <name>TMNAaccess_Notify_on_Employee_End_Date_Change</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <description>Send notification to manager every time an employee end date value is changed</description>
        <formula>AND(ISCHANGED(Last_Day__c), NOT(ISNEW()))</formula>
